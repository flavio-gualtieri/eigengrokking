...
from utils_main.data import get_torchvision_data
from utils_main.registry import OPTIMIZERS, ACTIVATIONS, LOSSES
from utils_spectrum.phi_eval import phi_mass_g1, phi_mean_var
from utils_general.dir_making import make_dirs
from utils_main.model import build_mlp, set_seed
from utils_spectrum.eigenthings import lanczos_phi_average
from utils_main.metrics import compute_accuracy, compute_loss
from utils_main.adversarial import generate_fgsm_adversarial_examples

from utils_general.io_utils import (
    save_checkpoint,
...
def run_experiment(cfg: ExperimentConfig) -> Dict[str, Any]:
    ...
    plot_path = dirs["fig"] / f"training_curve_{stem}.png"
